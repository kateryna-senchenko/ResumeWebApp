package com.onmyown.resumeapp.testenv;

import com.onmyown.resumeapp.model.LanguageLevel;
import com.onmyown.resumeapp.model.LanguageType;
...
public class TestDataGenerator {
    ...
    private static final String JDBC_PASSWORD = "kapitoshka348";
    ...
    private static final String MEDIA_DIR = "C:/Users/kater/IdeaProjects/ResumeWebApp/src/main/webapp/media";
    ...
    private static Date randomFinishEducation() {
        Calendar cl = Calendar.getInstance();
        cl.setTimeInMillis(birthDate.getTime());
